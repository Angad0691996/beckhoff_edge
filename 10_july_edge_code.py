...
def read_plc_nodes(plc, plc_name):
    ...
    try:
        # This call is protected by plc_access_lock in send_data_continuously
...
def create_parking_map_from_file(plc, plc_name, current_date, current_time, parking_map_file, queue_data_list):
    ...
    try:
        ...
        try:
            # This call is protected by plc_access_lock (via read_plc_nodes -> send_data_continuously)
...
def write_to_plc(plc, data, type_mapping):
    ...
    try:
        ...
        try:
            ...
            time.sleep(0.01)  # Small initial delay before polling
        except pyads.pyads_ex.ADSError as ads_e:
        ...
        ACK_TIMEOUT_SECONDS = 1 # Set a reasonable timeout for acknowledgment, reduce to 0.5 to check the speed if necessary (e.g., 1 seconds)
